...
const Testimonials = () => {
  return (
    <div className="max-w-7xl px-4 mx-auto sm:px-6 lg:px-8 py-12 dark:bg-black">
      {/* Title section */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {testimonials.map((testimonial) => (
          <div
            key={testimonial.id}
            className="flex flex-col max-w-md mx-auto md:mx-0 justify-between rounded-xl shadow hover:shadow-lg transition-shadow bg-white dark:bg-gray-900"
          >
            ...
            <div className="flex space-x-2 bg-gray-50 dark:bg-gray-800 px-6 pt-6 pb-5 rounded-b-xl">
