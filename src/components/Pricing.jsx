...
const Pricing = () => {
  ...
  return (
    <div className="py-10 md:px-20 lg:px-20 dark:bg-black">
      <div className="container mx-auto px-4">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-black-400 dark:text-gray-300">
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {plans.map((plan) => (
            <div
              ...
              } bg-[#1A1A1A] dark:bg-gray-900 hover:transform hover:-translate-y-2 transition-all duration-300`}
            >
              {plan.popular && (
                <div className="absolute -top-4 left-1/2 -translate-x-1/2 rounded-full bg-gradient-to-r from-violet-600 to-pink-500 px-3 py-1 text-white text-sm font-semibold">
                  Most Popular
                </div>
              )}
